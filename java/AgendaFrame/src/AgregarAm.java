...
public class AgregarAm 
{
	public static void createFrame(Agenda d, JButton bBus, JButton bEdi, JButton bEli, JFrame aux, boolean sw, Persona x)
	{
		JLabel lNombre, lApellido, lDirTra, lCorreo, lTelOfi, lTelCel, lDirCasa, lTelCasa, lFechaCumple, lApodo;
		...
		JTextField tNombre, tApellido, tDirTra, tCorreo, tTelOfi, tTelCel, tDirCasa, tTelCasa, tFechaCumple, tApodo;
		...
		EventQueue.invokeLater(new Runnable()
		{
			public void run()
			{
				...
				lApodo.setBounds(10, 550, 100, 30); tApodo.setBounds(60, 550, 100, 30);
				...
				frame.add(lApodo); frame.add(tApodo);
				frame.add(bAceptar);
				frame.add(bCancelar);
				frame.add(bLimpiar);
			...
			class AceptarBoton implements ActionListener
			{
				public void actionPerformed(ActionEvent ae)
				{
					...
					{
						p = new Amigos(n, a, dt, c, to, tc, dc, tcasa, fc, par);
